...
uint8_t AP_CollisionAvoidance_PX4::num_px4_instances = 0;
...
*/
AP_CollisionAvoidance_PX4::AP_CollisionAvoidance_PX4(CollisionAvoidance &_ranger, uint8_t instance, CollisionAvoidance::CollisionAvoidance_State &_state) :
...
*/
AP_CollisionAvoidance_PX4::~AP_CollisionAvoidance_PX4()
{
    if (_fd != -1) {
        close(_fd);
    }
...
*/
int AP_CollisionAvoidance_PX4::open_driver(void)
{
...
*/
bool AP_CollisionAvoidance_PX4::detect(CollisionAvoidance &_ranger, uint8_t instance)
{
    int fd = open_driver();
    if (fd == -1) {
        return false;
...
void AP_CollisionAvoidance_PX4::update(void)
{
    if (_fd == -1) {
        set_status(CollisionAvoidance::CollisionAvoidance_NotConnected);
        return;
