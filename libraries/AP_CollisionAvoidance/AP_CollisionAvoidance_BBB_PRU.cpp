...
*/
AP_CollisionAvoidance_BBB_PRU::AP_CollisionAvoidance_BBB_PRU(CollisionAvoidance &_ranger, uint8_t instance, CollisionAvoidance::CollisionAvoidance_State &_state) :
...
*/
bool AP_CollisionAvoidance_BBB_PRU::detect(CollisionAvoidance &_ranger, uint8_t instance)
{
    bool result = true;
    uint32_t mem_fd;
    uint32_t *ctrl;
...
*/
void AP_CollisionAvoidance_BBB_PRU::update(void)
{
    state.status = (CollisionAvoidance::CollisionAvoidance_Status)rangerpru->status;
