...
*/
AP_CollisionAvoidance_PulsedLightLRF::AP_CollisionAvoidance_PulsedLightLRF(CollisionAvoidance &_ranger, uint8_t instance, CollisionAvoidance::CollisionAvoidance_State &_state) :
...
bool AP_CollisionAvoidance_PulsedLightLRF::start_reading()
{
    ...
    if (hal.i2c->writeRegister(AP_COLLISIONAVOIDANCE_PULSEDLIGHTLRF_ADDR,
                               AP_COLLISIONAVOIDANCE_PULSEDLIGHTLRF_MEASURE_REG,
                               AP_COLLISIONAVOIDANCE_PULSEDLIGHTLRF_MSRREG_ACQUIRE) != 0) {
        i2c_sem->give();
        return false;
    }
