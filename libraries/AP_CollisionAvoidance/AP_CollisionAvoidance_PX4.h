...
#ifndef AP_CollisionAvoidance_PX4_H
#define AP_CollisionAvoidance_PX4_H

#include "CollisionAvoidance.h"
#include "CollisionAvoidance_Backend.h"

class AP_CollisionAvoidance_PX4 : public AP_CollisionAvoidance_Backend
{
public:
    // constructor
    AP_CollisionAvoidance_PX4(CollisionAvoidance &ranger, uint8_t instance, CollisionAvoidance::CollisionAvoidance_State &_state);

    // destructor
    ~AP_CollisionAvoidance_PX4(void);
...
#endif // AP_CollisionAvoidance_PX4_H
