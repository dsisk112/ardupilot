...
*/
AP_CollisionAvoidance_PX4_PWM::AP_CollisionAvoidance_PX4_PWM(CollisionAvoidance &_ranger, uint8_t instance, CollisionAvoidance::CollisionAvoidance_State &_state) :
...
*/
AP_CollisionAvoidance_PX4_PWM::~AP_CollisionAvoidance_PX4_PWM()
{
    if (_fd != -1) {
        close(_fd);
    }
...
*/
bool AP_CollisionAvoidance_PX4_PWM::detect(CollisionAvoidance &_ranger, uint8_t instance)
{
...
void AP_CollisionAvoidance_PX4_PWM::update(void)
{
    if (_fd == -1) {
        set_status(CollisionAvoidance::CollisionAvoidance_NotConnected);
        return;
